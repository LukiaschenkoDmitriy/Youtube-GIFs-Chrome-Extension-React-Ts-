...
const NotYoutubeScreen: React.FC = () => {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
            <div style={{ background: "#FFF7ED", display: "flex", justifyContent: "center", padding: "32px 24px 24px" }}>
                <YoutubeIllustration />
            </div>
            ...
            <div style={{ padding: "20px 24px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <button onClick={openYoutube} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", padding: "11px 0", fontSize: 14, fontWeight: 500, cursor: "pointer", borderRadius: 8, border: "none", background: "#FF0000", color: "#fff", fontFamily: "inherit" }}>
                    <FaYoutube />
                    Go to YouTube
                </button>
