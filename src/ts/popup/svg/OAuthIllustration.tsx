...
const OAuthIllustration: React.FC = () => (
	<svg width="240" height="160" viewBox="0 0 240 160" aria-hidden="true">
		...
		<text x="190" y="74" textAnchor="middle" fontSize="9" fill="#085041" fontFamily="sans-serif" fontWeight="500">
			Sign in
		</text>
		...
		<text x="120" y="54" textAnchor="middle" fontSize="8" fill="#185FA5" fontFamily="sans-serif">
			request
		</text>
		<text x="120" y="80" textAnchor="middle" fontSize="8" fill="#0F6E56" fontFamily="sans-serif">
			token
		</text>
		<text x="136" y="102" fontSize="8" fill="#534AB7" fontFamily="sans-serif">
			OAuth2
		</text>
	</svg>
);
