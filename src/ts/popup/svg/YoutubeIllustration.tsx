...
const YoutubeIllustration: React.FC = () => (
    <svg width="220" height="148" viewBox="0 0 220 148" role="img">
        ...
        <text x="88" y="30.5" textAnchor="middle" fontSize="6" fill="#B07D30" fontFamily="sans-serif">youtube.com</text>
        ...
        <text x="181" y="79.5" textAnchor="middle" fontSize="7" fill="#fff" fontFamily="sans-serif" fontWeight="500">Open</text>
    </svg>
);
